...
function playWithShadowLet() {
    let userName = "karayel";
    {
        let userName = "ikarayel";
...
let globalLetName = 'Im Global let';
let globalVarName = 'Im Global var';
...
function playWithConstObject() {
    const car = { type: "BMW", model: "i8", color: "white" };
...
//# sourceMappingURL=01_variableDeclaration.js.map